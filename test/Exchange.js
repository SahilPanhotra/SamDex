...
describe("Exchange", () => {
  let deployer, feeAccount, exchange, accounts, user1, user2, token1, token2;
  ...
  beforeEach(async () => {
    ...
    token1 = await Token.deploy("MY TOKEN", "SAM", 1000000);
    token2 = await Token.deploy("MOCK DAI STABLE COIN", "mDAI", 1000000);
  ...
  describe("Making Orders", () => {
    ...
    describe("Failure", () => {
      it("rejects with no token balance", async () => {
        await expect(
          exchange
            .connect(user1)
            .makeOrder(token2.address, tokens(1), token1.address, tokens(1))
  ...
  describe("Order Actions", () => {
    ...
    describe("Filling Orders", async () => {
      describe("Success", () => {
        ...
        it("executes the trade and charges a fee", async () => {
          expect(
            await exchange.balanceOf(token1.address, user1.address)
          ).to.equal(tokens(0));
          expect(
