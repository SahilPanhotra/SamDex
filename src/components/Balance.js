...
import sam from "../assets/logo.svg";
...
const Balance = () => {
  ...
  return (
    <div className="component exchange__transfers">
      ...
      {/* Deposit/Withdraw Component 1 (Sam) */}
      ...
      <div className="exchange__transfers--form">
        <div className="flex-between">
          <p>
            <small>Token</small>
            <br />
            <img src={sam} className="side__logo--token" alt="Token Logo" />
            {symbols && symbols[0]}
          </p>
          <p>
            <small>Wallet</small>
      ...
      <div className="exchange__transfers--form">
        <div className="flex-between">
          <p>
            <small>Token</small>
            <br />
            <img src={eth} className="side__logo--token" alt="Token Logo" />
            {symbols && symbols[1]}
          </p>
          <p>
            <small>Wallet</small>
